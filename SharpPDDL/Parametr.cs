...
namespace SharpPDDL
{
    internal class Parametr
    {
        ...
        public Parametr(Int32 hashCode, object oryginal)
        {
            ...
            {
                if ((propertyInfo.PropertyType.IsValueType || propertyInfo.PropertyType.IsClass ) && propertyInfo.CanRead) //...jesli jest wartoscia lub klasą i jest odczytywalny...
                {
            ...
            {
                if ((fieldInfo.FieldType.IsValueType || fieldInfo.FieldType.IsClass) && fieldInfo.IsPublic) //...jesli jest wartoscia lub klasą i jest publiczny...
                {
