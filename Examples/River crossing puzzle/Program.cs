...
namespace River_crossing_puzzle
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            TakingGoat.AddPrecondition("Boat is next the bank", ref nextToBank, b => b.IsBoat);
            TakingGoat.AddPrecondition("Goat is at the bank", ref nextToBank, b => b.IsGoat);
            TakingGoat.AddPrecondition("Boat is empty", ref boat, b => !b.IsCabbage && !b.IsGoat && !b.IsWolf);
            ...
            TakingWolf.AddPrecondition("Boat is next the bank", ref nextToBank, b => b.IsBoat);
            TakingWolf.AddPrecondition("Goat is at the bank", ref nextToBank, b => b.IsWolf);
            TakingWolf.AddPrecondition("Boat is empty", ref boat, b => !b.IsCabbage && !b.IsGoat && !b.IsWolf);
            ...
            PutGoatAway.AddPrecondition("Boat is next the bank", ref nextToBank, b => b.IsBoat);
            PutGoatAway.AddPrecondition("Goat is at the bank", ref boat, b => b.IsGoat);
            ...
            PutWolfAway.AddPrecondition("Boat is next the bank", ref nextToBank, b => b.IsBoat);
            PutWolfAway.AddPrecondition("Goat is at the bank", ref boat, b => b.IsWolf);
